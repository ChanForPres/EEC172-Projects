...
//    {
//			get = ROM_UARTCharGet(UART1_BASE);	//get the chars from the array 
//			drawChar(z*9,9*9,get,WHITE,BLUE,1);
//			z++;
//			
//			if(((i+1) % 16) == 0) {
//			    rows++;
...
//		drawFastHLine(0, 64, 128, WHITE); 					//this draws a line in middle of screen
